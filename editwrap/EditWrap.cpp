...
)
{
	...
	#ifdef _UNICODE
	if (psi.AdvControl(PluginNumber, ACTL_GETFARRECT, FADV1988 &rcFar, nullptr))
	{
	...
	*/
	...
	psi.AdvControl(PluginNumber, ACTL_GETWINDOWINFO, FADV1988 &wi, nullptr);
