...
bool ChattrDialog(Panel *SrcPanel)
{
	...
	if (Opt.Dialogs.UseModernLook) DlgHeight += 6; // + extra spaces
	...
	DialogDataEx ChattrDlgData[] = {
		...
		{DI_TEXT,      0, (short)(Opt.Dialogs.UseModernLook ? 4 : 5), 0, 4, {}, DIF_SEPARATOR, L""},
		{DI_LISTBOX,   4, (short)(Opt.Dialogs.UseModernLook ? 6: 5), (short)(DlgWidth - 5), (short)(DlgHeight - 5), {}, DIF_FOCUS | DIF_LISTNOBOX /*| DIF_LISTNOCLOSE*/, L""},
		{DI_TEXT,      0, (short)(DlgHeight - (Opt.Dialogs.UseModernLook ? 5 : 4)), 0, (short)(DlgHeight - 4), {}, (Opt.Dialogs.UseModernLook ? 0 : DIF_SEPARATOR), L""},
    ...
    if (Opt.Dialogs.UseModernLook) ++DlgHeight;
